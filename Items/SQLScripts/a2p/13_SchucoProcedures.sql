...
/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_MaterialPurchaseData]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_MaterialPurchaseData]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_MaterialNeeds]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_MaterialNeeds]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_MaterialColor]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_MaterialColor]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_Material]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_Material]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_InsertWorkforce]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_InsertWorkforce]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_InsertPositions]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_InsertPositions]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_InsertMNRecordGlass]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_InsertMNRecordGlass]
GO

/****** Object:  StoredProcedure [dbo].[Uniwave_a2p_InsertMNRecord]    Script Date: 2024-12-29 21:19:31 ******/
DROP PROCEDURE [dbo].[Uniwave_a2p_InsertMNRecord]
GO
...
?CREATE   PROCEDURE [dbo].[Uniwave_a2p_InsertMNRecord] 
	@File nvarchar(255),
...
BEGIN
	...
	declare @id int
?
INSERT INTO Uniwave_a2p_RecordsMaterials ([File], Project, ArticleNo, Description, Color,TotalPrice,QuantityEA,Quantity,Delivery,Dimensions,Weight,InsertDate)
...
?
	...
	update dbo.Uniwave_a2p_RecordsMaterials set DocNumber = @Number, DocVersion = @Version where Id = @id
...
?
	set @Color = @P_Color1
?
	EXEC dbo.Uniwave_a2p_MaterialColor @P_Color1 ,''
?
	if (@Color2 != '')
	BEGIN
...
?
		...
		EXEC dbo.Uniwave_a2p_MaterialColor @P_Color2 ,''
?
...
?
?
	EXEC dbo.Uniwave_a2p_Material @ReferenceBase, @Reference, @Description, @MaterialType, @Color, @pPackage
?
	IF @MaterialType = 'Bar'
	EXEC dbo.Uniwave_a2p_MaterialPurchaseData @Reference,  1, @Price, @ProviderReference ,@Description,@Color
	ELSE 
	EXEC dbo.Uniwave_a2p_MaterialPurchaseData @Reference, @pPackage, @Price,  @ProviderReference,@Description,@Color
?
	...
	EXEC dbo.Uniwave_a2p_MaterialNeeds @Number, @Version, @Reference, @MaterialType, @mnWidth, @mnHeight,@mnWeight,@QuantityEA,'', @pToOrder
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_InsertMNRecordGlass] 
	@Project nvarchar(255),
	@Item nvarchar(255),
	@Field int,
	@Quantity int,
...
INSERT INTO [dbo].[Uniwave_a2p_RecordsGlasses]
           (
			[Project] ,
			[Item] ,
			[Field],
	...
	/*Check color, if not exists than insert*/
	/*======================================*/
	EXEC dbo.Uniwave_a2p_MaterialColor 'Glass', @Prefix
	IF EXISTS(SELECT * FROM dbo.MaterialesBase MB 
	...
	/*======================================*/
	EXEC dbo.Uniwave_a2p_Material @pReferenciaBase, @pReferencia, @pDescription, @MaterialType, @pColor, @pPackage

	/*Check purchase data, if not exists than insert*/
	/*======================================*/
	EXEC dbo.Uniwave_a2p_MaterialPurchaseData @pReferencia, @pPackage, @Price, @pReferencia ,@pDescription,''


	/*Check material needs, if not exists than insert*/
	/*======================================*/
	EXEC dbo.Uniwave_a2p_MaterialNeeds @Number, @Version, @pReferencia, @MaterialType, @Width,@Height,@Weight,@Quantity,@Field,1
...
-----------------------------------------------------[Uniwave_a2p_InsertPositions]

CREATE    PROCEDURE [dbo].[Uniwave_a2p_InsertPositions]     
...
INSERT INTO dbo.Uniwave_a2p_RecordsPositions
(
    ProjectNumber,
	ProjectName,
	ItemNumber,
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_InsertWorkforce]	
@Number INT, 
@Version INT, 
@sModified DATETIME 
AS
BEGIN
	...
	FROM dbo.Uniwave_a2p_RecordsPositions srp
	...
	update Uniwave_a2p_RecordsPositions set ModifiedDate = @sModified where Id = @RowId
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_Material] 
...
BEGIN
	...
	(   'AE8D70E6-C414-412A-B272-AE141FCFA63F', -- MakerId - uniqueidentifier
		...
		CASE WHEN @MaterialType = 'Panel'  AND @pReferenciaBase LIKE 'Uniwave_a2p_AluSheet%' THEN @sDescription + ' ' + SUBSTRING(@pColor,6,44)
		     WHEN @MaterialType = 'Surface' AND @pReferenciaBase LIKE 'Uniwave_a2p_AluSheet%' THEN @sDescription + ' ' + SUBSTRING(@pColor,6,44)
			 ELSE
			 @sDescription
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_MaterialColor] 
	-- Add the parameters for the stored procedure here
	@sColor nvarchar(50) ,
	@Prefix NVARCHAR(5)
AS
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_MaterialNeeds] 
	-- Add the parameters for the stored procedure here
	@Number INT, 
	@Version INT, 
	@pReferencia NVARCHAR(25),
...
CREATE    PROCEDURE [dbo].[Uniwave_a2p_MaterialPurchaseData] 
	-- Add the parameters for the stored procedure here
	@pReferencia  NVARCHAR(25), 
	@pPackage real,
	@sPrice FLOAT,

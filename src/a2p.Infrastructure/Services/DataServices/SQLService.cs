...
namespace a2p.Infrastructure.Services.DataServices
{
    public class SQLService : ISQLService
    {
        ...
        private Application.Models.SettingsContainer _settingsContainer;
        private AppSettings _appSettings;
        private readonly string _connectionString;

        private readonly ILogger _logger;

        public SQLService(ISettingsService settingsService, ILogger logger)
        {
            try
            {
                ...
                {
                    _logger.LogError("UserSettingsService is null", "SQL Repository: Unhandled error initializing SQL Repository. Please check Settings.");
                ...
                {
                    _logger.LogError("AppSettings is null", "SQL Repository: Unhandled error initializing SQL Repository. Please check Settings.");
                ...
                {
                    _logger.LogError("SettingsContainer is null", "SQL Repository: Unhandled error initializing SQL Repository. Please check Settings.");
                ...
                {
                    _logger.LogError("ConnectionString is null or empty", "SQL Repository: Unhandled error initializing SQL Repository. Please check Settings.");

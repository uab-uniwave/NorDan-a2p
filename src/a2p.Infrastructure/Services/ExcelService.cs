...
namespace a2p.Infrastructure.Services
{
    public class ExcelService : IExcelService
    {
        ...
        public void WriteExcelErrorLog(string file, List<A2PErrorDto> A2PError)
        {


            List<A2PErrorDto> criticalErrors = A2PError
            ...
            if (criticalErrors.Count > 0)
            {
                ...
                using (XLWorkbook workbook = new())
                {
                    ...
                    foreach (A2PErrorDto error in criticalErrors)
                    {

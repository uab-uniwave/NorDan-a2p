...
namespace a2p.Infrastructure.Services
{
    public class SQLRepository : ISQLRepository
    {
        ...
        public async Task<A2PErrorDto?> DeleteSalesDocumentDataAsync(int number, int version, bool deleteExisting)
        {
        ...
        public async Task<A2PErrorDto?> InsertOrderMaterialDTOAsync(MaterialDTO materialDTO, int number, int version)
        {
        ...
        public async Task<A2PErrorDto?> InsertOrderItemDTOAsync(ItemDTO itemDTO, int number, int version, string idPos)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteColorAsync(MaterialDTO materialDTO)
        {
            try
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteColorConfigurationAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialBaseAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialProfileAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialMeterAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialPieceAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialSurfaceAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialPurchaseDataAsync(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> UpdateBCMapping(MaterialDTO materialDTO)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialNeedsMasterAsync(string order, int number, int version)
        {
        ...
        public async Task<A2PErrorDto?> InsertPrefSuiteMaterialNeedsAsync(string order, int number, int version)
        {

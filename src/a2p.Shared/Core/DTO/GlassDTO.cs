namespace a2p.Shared.Core.DTO
{
    public class GlassDTO : BaseDTO
    {
        ...
        public double Ordered { get; set; } = 0; //normally used in panels TODO: check if needed
        public double Waste { get; set; } = 0; //normally used in panels TODO: check if needed

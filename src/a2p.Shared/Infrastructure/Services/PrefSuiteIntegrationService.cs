...
{
    public class PrefSuiteIntegrationService : IPrefSuiteIntegrationService
    {
        private readonly ILogService _logService;
        private readonly ISqlRepository _sqlRepository;
        private readonly IConfiguration _configuration;
        private readonly Interop.PrefDataManager.IPrefDataSource _prefSuiteOLEDBConnection;
        public PrefSuiteIntegrationService(ILogService logService, ISqlRepository sqlRepository, IConfiguration configuration)
        {

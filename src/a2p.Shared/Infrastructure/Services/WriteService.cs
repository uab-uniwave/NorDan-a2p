    ...
    public class WriteService : IWriteService
    {
        ...
        public async Task<int> InsertMaterialAsync(MaterialDTO materialDTO)
        {
            try
            {
                ...
                _ = cmd.Parameters.AddWithValue("@Name", materialDTO.WorksheetName);
        ...
        public async Task<int> InsertGlassAsync(GlassDTO glassDTO)
        {
            try
            {
                ...
                _ = cmd.Parameters.AddWithValue("@AreaOrdered", glassDTO.AreaOrdered);
        ...
        public async Task<int> InsertPanelAsync(PanelDTO panelDTO)
        {
            try
            {
                ...
                _ = cmd.Parameters.AddWithValue("@AreaOrdered", panelDTO.AreaOrdered);

...
namespace WinFormApp.Forms
{
    public partial class LogsForm : Form
    {
        ...
        private readonly ILogger<LogsForm> _logger;
        ...
        public LogsForm(ISettingsService settingsService, ILogger<LogsForm> logger)
        {
            _logger = logger;
        ...
        private void InitializeTable()
        {
            ...
            {
                string className = nameof(LogsForm); // Replace with the actual class name if different

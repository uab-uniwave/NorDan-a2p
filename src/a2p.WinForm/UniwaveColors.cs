namespace a2p.WinForm
{
    public static class UniwaveColors {
        ...
        public static Color uwGreyDark => Color.FromArgb(57, 74, 85);
        public static Color uwGreyDeep => Color.FromArgb(98, 98, 98);
        ...
        public static Color a2pGreyDeep => Color.FromArgb(122, 123, 124);
